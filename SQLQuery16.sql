CREATE DATABASE db_LIBRARY_MANAGEMENTfinal

USE db_LIBRARY_MANAGEMENTfinal
...
VALUES
	(1, 1, 1008, '10/18/2018', '11/18/2019'),
	(2, 2, 1009,'10/10/2018', '11/10/2019'),
	(7, 2, 1004, '10/18/2018', '11/19/2019'),
	(4, 3, 1000,'10/1202018', '11/18/2019'),
	(5, 4, 1007,'10/23/2018', '11/30/2019'),
	(6, 2, 1001,'09/18/2018', '11/08/2018'),
	(3, 1, 1004, '08/18/2018', '12/18/2019'),
	(8, 4, 1000, '10/11/2018', '11/11/2019'),
	(9, 3, 1003, '10/06/2018', '10/18/2019'),
	(10, 3, 1004, '03/18/2018', '10/18/2019'),
	(11, 1, 1005,'06/20/2018', '11/20/2019'),
	(12, 3, 1009, '10/06/2018', '11/06/2019'),
	(13, 2, 1008, '03/28/2018', '12/18/2019'),
	(14, 4, 1007, '04/18/2018', '11/18/2019'),
	(15, 1, 1004, '10/18/2018', '11/18/2019'),
	(16, 2, 1005,'06/18/2018', '09/28/2019'),
	(17, 4, 1007, '10/26/2018', '11/23/2019'),
	(18, 2, 1005, '10/30/2018', '11/124/2019'),
	(19, 4, 1004, '07/21/2019', '09/29/2019'),
	(20, 2, 1001,'08/28/2019', '11/28/2019')
;

/* 10/18/2019 is declared as TODAY for task 4 as the drill test BOOKSTORE, assumed that all copies are not returned */
...
EXECUTE [dbo].[getDrill4]


SELECT tbl_LIBRARY_BRANCH.LIBRARY_BranchName, SUM (tbl_books_COPIES.COPIES_Number_Of_Copies)
...
EXECUTE [dbo].[getDrill5]


SELECT tbl_BORROWER.BORROWER_Name, tbl_BORROWER.BORROWER_Address, SUM (tbl_books_COPIES.COPIES_Number_Of_Copies)
FROM tbl_BORROWER
INNER JOIN tbl_books_LOANS ON tbl_BORROWER.BORROWER_CardNo_ID = tbl_books_LOANS.LOANS_CardNo
INNER JOIN tbl_books_COPIES ON tbl_books_COPIES.COPIES_BookID = tbl_books_LOANS.LOANS_BookID
INNER JOIN tbl_books ON tbl_books.BOOKS_BookId = tbl_books_LOANS.LOANS_BookID
	
GROUP BY tbl_BORROWER.BORROWER_Name, tbl_BORROWER.BORROWER_Address HAVING SUM (tbl_books_COPIES.COPIES_Number_Of_Copies) > 5
;
GO

EXECUTE [dbo].[getDrill6]
